<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calculadora.aspx.cs" Inherits="Calculadora_v3.Calculadora" %>
...
<body>
    ...
    <div>
        ...
        <asp:Label ID="lblCalculadora" runat="server" Text="Calculadora" ForeColor="Red"></asp:Label>
        <br /><asp:TextBox ID="txtOperando1" runat="server"></asp:TextBox>
        <br /><asp:TextBox ID="txtOperando2" runat="server"></asp:TextBox>
        <br /><asp:Button ID="btnOperar" runat="server" Text="Operar" ForeColor="Red" OnClick="btnOperar_Click" />
        ...
        <br /><asp:Button ID="btnLimpiar" runat="server" Text="Limpiar" ForeColor="Red" OnClick="btnLimpiar_Click" />
    </form>
</body>
</html>
